...
import { MatTableDataSource, MatSort, MatPaginator, MatTableModule, MatDialog, Sort, MatDialogRef } from "@angular/material";
...
@Component({
    selector: 'detail-list-process',
    templateUrl: './detail-list-process.html',
    styleUrls: ['./detail-list-process.scss']
})
export class DetailListProcessComponent implements OnInit, AfterViewInit {
    ...
    constructor(private dialogRef: MatDialogRef<DetailListProcessComponent>,
